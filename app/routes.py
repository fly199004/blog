...
from app.models import User, EditProfileForm
...
@login_required
def index():
    # user = {'username': 'xiaofei'}
    posts = [
        {
            'author': {'username':'xiaofei'},
            'body':'Beautiful day in Philippines!'
        },{
            'author': {'username':'Fleury'},
...
def user(username):
    ...
    posts = [
        {'author':user,'body':'Hello World! Test post #1'},
        {'author':user,'body':'Hello World! Test post #2'},
